...
contract CollectionFactory is Ownable {
    ...
    function createCollection(
        ...
        require(msg.value >= price, "BorealisRoyalty: Pay the required amount");

        collectionId_.increment();
        BorealisRoyalty NFTContract = new BorealisRoyalty(
            name_,
            symbol_,
            msg.sender
        );
        ...
        external
    {
        require(
            ...
            "Contract doesn't exist in scope of Factory"
        );
