...
import "./interfaces/IBorealisRoyalty.sol";
...
contract NFTMarket is ReentrancyGuard {
    ...
    function createAuctionBid(uint256 itemId) external payable nonReentrant {
        ...
        require(
            ...
            "You need to pay more than floor price"
        );
        require(
            msg.value > currentInfo.highestBid,
            "You need to pay more than current highest bid"
        );
        ...
        nonReentrant
    {
        ...
        require(
            ...
            "Sender is not the highest bidder"
        );
